...
Resumo operacional das notificacoes internas arquivadas candidatas a exclusao:

```bash
curl -s "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/resumo-operacional?usuarioId=USUARIO_ID&tipoNotificacao=ServicoSolicitado&dataCriacaoInicial=2026-03-12T00:00:00Z&dataCriacaoFinal=2026-03-12T23:59:59Z" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
Resumo por tipo das notificacoes internas arquivadas candidatas a exclusao:

```bash
curl -s "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/resumo-tipos?usuarioId=USUARIO_ID&dataCriacaoInicial=2026-03-12T00:00:00Z&dataCriacaoFinal=2026-03-12T23:59:59Z" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```

Resumo por usuario das notificacoes internas arquivadas candidatas a exclusao:

```bash
curl -s "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/resumo-usuarios?tipoNotificacao=ServicoSolicitado&dataCriacaoInicial=2026-03-12T00:00:00Z&dataCriacaoFinal=2026-03-12T23:59:59Z" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```

Serie temporal das notificacoes internas arquivadas candidatas a exclusao:

```bash
curl -s "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/serie?usuarioId=USUARIO_ID&tipoNotificacao=ServicoSolicitado&dataCriacaoInicial=2026-03-12T00:00:00Z&dataCriacaoFinal=2026-03-12T23:59:59Z" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
```bash
curl -s "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/dashboard?usuarioId=USUARIO_ID&tipoNotificacao=ServicoSolicitado&dataCriacaoInicial=2026-03-12T00:00:00Z&dataCriacaoFinal=2026-03-12T23:59:59Z" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
```bash
curl -X POST "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN" \
  -H "Content-Type: application/json" \
  -d '{"usuarioId":"USUARIO_ID","tipoNotificacao":"ServicoSolicitado","lida":false,"limite":100}'
```

Preview da exclusao fisica em lote de notificacoes internas arquivadas:

```bash
curl -X POST "http://localhost:5231/api/notificacoes/arquivadas/excluir-lote/preview" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN" \
  -H "Content-Type: application/json" \
  -d '{"usuarioId":"USUARIO_ID","tipoNotificacao":"ServicoSolicitado","lida":false,"limite":100}'
```
