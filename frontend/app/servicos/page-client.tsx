        ...
        <section className="rounded-[2.2rem] border border-white/80 bg-white/88 p-6 shadow-[0_28px_80px_rgba(15,23,42,0.08)]">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 data-display="true" className="mt-2 text-4xl font-semibold leading-[0.98] text-slate-900">Meus serviços</h1>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            <div className="rounded-[1.4rem] bg-[linear-gradient(180deg,#fff7ed_0%,#ffffff_100%)] px-4 py-4">
            ...
            <div className="rounded-[1.4rem] bg-[linear-gradient(180deg,#fff7ed_0%,#ffffff_100%)] px-4 py-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Leitura rápida</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">Cliente</p>
            </div>
            <div className="rounded-[1.4rem] bg-[linear-gradient(180deg,#fff7ed_0%,#ffffff_100%)] px-4 py-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Visão</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">Timeline por serviço</p>
            </div>
          </div>
